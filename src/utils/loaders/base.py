...
class BaseDataset(metaclass=ABCMeta):
    ...
    def __init__(self, dataset: str) -> None:
        # read files
        self.arr_train_pos, self.dict_train_pos = self._load_pos(f"./src/datasets/{dataset}/train_user_items.pkl")
        self.arr_test_pos, self.dict_test_pos = self._load_pos(f"./src/datasets/{dataset}/test_user_items.pkl")
    ...
    def _load_pos(self, path_dataset: str) -> Tuple[np.ndarray, UserItems]:
